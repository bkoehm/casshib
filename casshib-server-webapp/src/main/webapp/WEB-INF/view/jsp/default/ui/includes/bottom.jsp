                ...
                <div id="footer" class="fl-panel fl-note fl-bevel-white fl-font-size-80">
                    ...
                    <a href="http://www.jasig.org" title="go to Jasig home page"><img id="logo" src="${contextPath}/images/ja-sig-logo.gif" width="118" height="31" alt="JA-SIG" title="go to Jasig home page" /></a>
                </div>
            </div>
        </div>
    </body>
